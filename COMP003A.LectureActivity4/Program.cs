    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            /*
             * The while statement executes a statement or a block of statements while aspecified
             * Boolean expression evaluates to true. Because that expression isevaluated before
             * each execution of the loop, a while loop executes zero or more times. Thewhile
            ...
            */
            ...
            Console.WriteLine("\n"); // new line
            Console.WriteLine("".PadRight(50, '*'));
            Console.WriteLine("example for loop program that counter from 1-20 andchecks if it is odd or even");
            Console.WriteLine("".PadRight(50, '*'));
